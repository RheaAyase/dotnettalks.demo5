...
namespace UPower.DBus
{
    ...
    interface IUPower : IDBusObject
    {
        ...
        Task<IDisposable> WatchDeviceAddedAsync(Action<ObjectPath> action);
        Task<IDisposable> WatchDeviceRemovedAsync(Action<ObjectPath> action);
    ...
    interface IKbdBacklight : IDBusObject
    {
        ...
        Task<IDisposable> WatchBrightnessChangedAsync(Action<int> action);
    }
    ...
    interface IWakeups : IDBusObject
    {
        ...
        Task<IDisposable> WatchTotalChangedAsync(Action<uint> action);
        Task<IDisposable> WatchDataChangedAsync(Action action);
        Task<T> GetAsync<T>(string prop);
